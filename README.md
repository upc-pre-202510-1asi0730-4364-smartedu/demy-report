...
| 3.0     | 13/04/2025 | Daniel Crispin <br> Rafael Dominguez <br> Salim Ramirez <br> Paúl Sulca <br> Diego Vilca     | Se completó el Capítulo II: Requirements Elicitation & Analysis, incluyendo personas, escenarios y requerimientos iniciales. |
| 3.1     | 16/04/2025 | Daniel Crispin <br> Rafael Dominguez <br> Salim Ramirez <br> Paúl Sulca <br> Diego Vilca     | Se integraron las User Stories, Landing Page Stories y Technical Stories como parte del Capítulo III.                        |
| 4.0     | 18/04/2025 | Daniel Crispin <br> Rafael Dominguez <br> Salim Ramirez <br> Paúl Sulca <br> Diego Vilca     | Se completó el Capítulo III: Requirements Specification, detallando los criterios de aceptación y modelo de casos de uso.    |
| 4.1     | 21/04/2025 | Daniel Crispin <br> Rafael Dominguez <br> Salim Ramirez <br> Paúl Sulca <br> Diego Vilca     | Se añadieron los style guidelines, mockups, wireframes, wireflow y userflow en el Capítulo IV: Product Design.               |
...
| TS01            | Implementar endpoint para obtener todos los cursos (`GET /courses`)                                      | Como developer,<br>quiero exponer un endpoint para obtener todos los cursos,<br>para que los usuarios puedan ver la lista completa de cursos.                                                          | **Scenario 1:** Cursos encontrados<br>Given que existen cursos en el sistema<br>When se consulta el endpoint<br>Then se retorna status 200 OK con lista de cursos<br><br>**Scenario 2:** No hay cursos<br>Given que no existen cursos en el sistema<br>When se consulta el endpoint<br>Then se retorna status 200 OK con lista vacía                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | EP07                                                                                                                                 |
| TS02            | Implementar endpoint para consultar un curso por ID (`GET /courses/{id}`)                                | Como developer,<br>quiero exponer un endpoint que devuelva un curso por su ID,<br>para que los usuarios puedan obtener los detalles del curso.                                                         | **Scenario 1:** Curso encontrado<br>Given que el ID del curso existe<br>When se consulta el endpoint<br>Then se retorna status 200 OK con los detalles del curso<br><br>**Scenario 2:** Curso no encontrado<br>Given que el ID del curso no existe<br>When se consulta el endpoint<br>Then se retorna 404 Not Found                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | EP07                                                                                                                                 |
| TS03            | Implementar endpoint para registrar un nuevo curso (`POST /courses`)                                     | Como developer,<br>quiero exponer un endpoint para registrar un curso,<br>para que los usuarios puedan crear un curso en el sistema.                                                                   | **Scenario 1:** Curso registrado correctamente<br>Given que los datos del curso son válidos<br>When se consulta el endpoint<br>Then se retorna status 201 Created con el curso registrado<br><br>**Scenario 2:** Datos inválidos<br>Given que los datos del curso son inválidos<br>When se consulta el endpoint<br>Then se retorna 400 Bad Request con mensaje de error                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | EP07                                                                                                                                 |
| TS04            | Implementar endpoint para actualizar un curso (`PUT /courses/{id}`)                                      | Como developer,<br>quiero exponer un endpoint para actualizar un curso,<br>para que los usuarios puedan modificar los detalles de un curso existente.                                                  | **Scenario 1:** Curso actualizado correctamente<br>Given que el ID del curso existe y los datos son válidos<br>When se consulta el endpoint<br>Then se retorna status 200 OK con los detalles actualizados<br><br>**Scenario 2:** Curso no encontrado<br>Given que el ID del curso no existe<br>When se consulta el endpoint<br>Then se retorna 404 Not Found                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | EP07                                                                                                                                 |
| TS05            | Implementar endpoint para eliminar un curso (`DELETE /courses/{id}`)                                     | Como developer,<br>quiero exponer un endpoint para eliminar un curso,<br>para que los usuarios puedan eliminar un curso del sistema.                                                                   | **Scenario 1:** Curso eliminado correctamente<br>Given que el ID del curso existe<br>When se consulta el endpoint<br>Then se retorna status 204 No Content<br><br>**Scenario 2:** Curso no encontrado<br>Given que el ID del curso no existe<br>When se consulta el endpoint<br>Then se retorna 404 Not Found                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | EP07                                                                                                                                 |
| TS06            | Implementar endpoint para obtener todas las aulas (`GET /classrooms`)                                    | Como developer,<br>quiero exponer un endpoint para obtener todas las aulas,<br>para que los usuarios puedan ver la lista completa de aulas.                                                            | **Scenario 1:** Aulas encontradas<br>Given que existen aulas en el sistema<br>When se consulta el endpoint<br>Then se retorna status 200 OK con lista de aulas<br><br>**Scenario 2:** No hay aulas<br>Given que no existen aulas en el sistema<br>When se consulta el endpoint<br>Then se retorna status 200 OK con lista vacía                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | EP07                                                                                                                                 |
| TS07            | Implementar endpoint para consultar un aula por ID (`GET /classrooms/{id}`)                              | Como developer,<br>quiero exponer un endpoint que devuelva un aula por su ID,<br>para que los usuarios puedan obtener los detalles del aula.                                                           | **Scenario 1:** Aula encontrada<br>Given que el ID del aula existe<br>When se consulta el endpoint<br>Then se retorna status 200 OK con los detalles del aula<br><br>**Scenario 2:** Aula no encontrada<br>Given que el ID del aula no existe<br>When se consulta el endpoint<br>Then se retorna 404 Not Found                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | EP07                                                                                                                                 |
| TS08            | Implementar endpoint para registrar una nueva aula (`POST /classrooms`)                                  | Como developer,<br>quiero exponer un endpoint para registrar una aula,<br>para que los usuarios puedan crear una nueva aula.                                                                           | **Scenario 1:** Aula registrada correctamente<br>Given que los datos del aula son válidos<br>When se consulta el endpoint<br>Then se retorna status 201 Created con el aula registrada<br><br>**Scenario 2:** Datos inválidos<br>Given que los datos del aula son inválidos<br>When se consulta el endpoint<br>Then se retorna 400 Bad Request con mensaje de error                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | EP07                                                                                                                                 |
| TS09            | Implementar endpoint para actualizar una aula (`PUT /classrooms/{id}`)                                   | Como developer,<br>quiero exponer un endpoint para actualizar una aula,<br>para que los usuarios puedan modificar los detalles de un aula existente.                                                   | **Scenario 1:** Aula actualizada correctamente<br>Given que el ID del aula existe y los datos son válidos<br>When se consulta el endpoint<br>Then se retorna status 200 OK con los detalles actualizados<br><br>**Scenario 2:** Aula no encontrada<br>Given que el ID del aula no existe<br>When se consulta el endpoint<br>Then se retorna 404 Not Found                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | EP07                                                                                                                                 |
| TS10            | Implementar endpoint para eliminar una aula (`DELETE /classrooms/{id}`)                                  | Como developer,<br>quiero exponer un endpoint para eliminar una aula,<br>para que los usuarios puedan eliminar un aula del sistema.                                                                    | **Scenario 1:** Aula eliminada correctamente<br>Given que el ID del aula existe<br>When se consulta el endpoint<br>Then se retorna status 204 No Content<br><br>**Scenario 2:** Aula no encontrada<br>Given que el ID del aula no existe<br>When se consulta el endpoint<br>Then se retorna 404 Not Found                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | EP07                                                                                                                                 |
| TS11            | Implementar endpoint para obtener todos los horarios semanales (`GET /weeklyschedules`)                  | Como developer,<br>quiero exponer un endpoint para obtener todos los horarios semanales,<br>para que los usuarios puedan ver la lista completa de horarios.                                            | **Scenario 1:** Horarios semanales encontrados<br>Given que existen horarios semanales en el sistema<br>When se consulta el endpoint<br>Then se retorna status 200 OK con lista de horarios<br><br>**Scenario 2:** No hay horarios semanales<br>Given que no existen horarios semanales en el sistema<br>When se consulta el endpoint<br>Then se retorna status 200 OK con lista vacía                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | EP07                                                                                                                                 |
| TS12            | Implementar endpoint para consultar un horario semanal por ID (`GET /weeklyschedules/{id}`)              | Como developer,<br>quiero exponer un endpoint que devuelva un horario semanal por su ID,<br>para que los usuarios puedan obtener los detalles del horario.                                             | **Scenario 1:** Horario semanal encontrado<br>Given que el ID del horario semanal existe<br>When se consulta el endpoint<br>Then se retorna status 200 OK con los detalles del horario<br><br>**Scenario 2:** Horario semanal no encontrado<br>Given que el ID del horario semanal no existe<br>When se consulta el endpoint<br>Then se retorna 404 Not Found                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | EP07                                                                                                                                 |
| TS13            | Implementar endpoint para registrar un nuevo horario semanal (`POST /weeklyschedules`)                   | Como developer,<br>quiero exponer un endpoint para registrar un horario semanal,<br>para que los usuarios puedan crear un nuevo horario semanal en el sistema.                                         | **Scenario 1:** Horario semanal registrado correctamente<br>Given que los datos del horario semanal son válidos<br>When se consulta el endpoint<br>Then se retorna status 201 Created con el horario semanal registrado<br><br>**Scenario 2:** Datos inválidos<br>Given que los datos del horario semanal son inválidos<br>When se consulta el endpoint<br>Then se retorna 400 Bad Request con mensaje de error                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | EP07                                                                                                                                 |
| TS14            | Implementar endpoint para actualizar un horario semanal (`PUT /weeklyschedules/{id}`)                    | Como developer,<br>quiero exponer un endpoint para actualizar un horario semanal,<br>para que los usuarios puedan modificar los detalles de un horario semanal existente.                              | **Scenario 1:** Horario semanal actualizado correctamente<br>Given que el ID del horario semanal existe y los datos son válidos<br>When se consulta el endpoint<br>Then se retorna status 200 OK con los detalles actualizados<br><br>**Scenario 2:** Horario semanal no encontrado<br>Given que el ID del horario semanal no existe<br>When se consulta el endpoint<br>Then se retorna 404 Not Found                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | EP07                                                                                                                                 |
| TS15            | Implementar endpoint para eliminar un horario semanal (`DELETE /weeklyschedules/{id}`)                   | Como developer,<br>quiero exponer un endpoint para eliminar un horario semanal,<br>para que los usuarios puedan eliminar un horario semanal del sistema.                                               | **Scenario 1:** Horario semanal eliminado correctamente<br>Given que el ID del horario semanal existe<br>When se consulta el endpoint<br>Then se retorna status 204 No Content<br><br>**Scenario 2:** Horario semanal no encontrado<br>Given que el ID del horario semanal no existe<br>When se consulta el endpoint<br>Then se retorna 404 Not Found                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | EP07                                                                                                                                 |
| TS16            | Implementar endpoint para consultar un horario semanal por nombre (`GET /weeklyschedules/name/{name}`)   | Como developer,<br>quiero exponer un endpoint para consultar un horario semanal por su nombre,<br>para que los usuarios puedan obtener los detalles del horario semanal mediante el nombre.            | **Scenario 1:** Horario semanal encontrado<br>Given que el nombre del horario semanal existe<br>When se consulta el endpoint<br>Then se retorna status 200 OK con los detalles del horario semanal<br><br>**Scenario 2:** Horario semanal no encontrado<br>Given que el nombre del horario semanal no existe<br>When se consulta el endpoint<br>Then se retorna 404 Not Found | EP16 |
...
| 34      | TS01          | Implementar endpoint para obtener todos los cursos (`GET /courses`)                                    | Como developer,<br>quiero exponer un endpoint para obtener todos los cursos,<br>para que los usuarios puedan ver la lista completa de cursos.                                                  | 3             |
| 35      | TS02          | Implementar endpoint para consultar un curso por ID (`GET /courses/{id}`)                              | Como developer,<br>quiero exponer un endpoint que devuelva un curso por su ID,<br>para que los usuarios puedan obtener los detalles del curso.                                                 | 2             |
| 36      | TS03          | Implementar endpoint para registrar un nuevo curso (`POST /courses`)                                   | Como developer,<br>quiero exponer un endpoint para registrar un curso,<br>para que los usuarios puedan crear un curso en el sistema.                                                           | 3             |
| 37      | TS04          | Implementar endpoint para actualizar un curso (`PUT /courses/{id}`)                                    | Como developer,<br>quiero exponer un endpoint para actualizar un curso,<br>para que los usuarios puedan modificar los detalles de un curso existente.                                          | 2             |
| 38      | TS05          | Implementar endpoint para eliminar un curso (`DELETE /courses/{id}`)                                   | Como developer,<br>quiero exponer un endpoint para eliminar un curso,<br>para que los usuarios puedan eliminar un curso del sistema.                                                           | 2             |
| 39      | TS06          | Implementar endpoint para obtener todas las aulas (`GET /classrooms`)                                  | Como developer,<br>quiero exponer un endpoint para obtener todas las aulas,<br>para que los usuarios puedan ver la lista completa de aulas.                                                    | 3             |
| 40      | TS07          | Implementar endpoint para consultar un aula por ID (`GET /classrooms/{id}`)                            | Como developer,<br>quiero exponer un endpoint que devuelva un aula por su ID,<br>para que los usuarios puedan obtener los detalles del aula.                                                   | 2             |
| 41      | TS08          | Implementar endpoint para registrar una nueva aula (`POST /classrooms`)                                | Como developer,<br>quiero exponer un endpoint para registrar una aula,<br>para que los usuarios puedan crear una nueva aula.                                                                   | 3             |
| 42      | TS09          | Implementar endpoint para actualizar una aula (`PUT /classrooms/{id}`)                                 | Como developer,<br>quiero exponer un endpoint para actualizar una aula,<br>para que los usuarios puedan modificar los detalles de un aula existente.                                           | 2             |
| 43      | TS10          | Implementar endpoint para eliminar una aula (`DELETE /classrooms/{id}`)                                | Como developer,<br>quiero exponer un endpoint para eliminar una aula,<br>para que los usuarios puedan eliminar un aula del sistema.                                                            | 2             |
| 44      | TS11          | Implementar endpoint para obtener todos los horarios semanales (`GET /weeklyschedules`)                | Como developer,<br>quiero exponer un endpoint para obtener todos los horarios semanales,<br>para que los usuarios puedan ver la lista completa de horarios.                                    | 3             |
| 45      | TS12          | Implementar endpoint para consultar un horario semanal por ID (`GET /weeklyschedules/{id}`)            | Como developer,<br>quiero exponer un endpoint que devuelva un horario semanal por su ID,<br>para que los usuarios puedan obtener los detalles del horario semanal.                             | 2             |
| 46      | TS13          | Implementar endpoint para registrar un nuevo horario semanal (`POST /weeklyschedules`)                 | Como developer,<br>quiero exponer un endpoint para registrar un horario semanal,<br>para que los usuarios puedan crear un nuevo horario semanal en el sistema.                                 | 3             |
| 47      | TS14          | Implementar endpoint para actualizar un horario semanal (`PUT /weeklyschedules/{id}`)                  | Como developer,<br>quiero exponer un endpoint para actualizar un horario semanal,<br>para que los usuarios puedan modificar los detalles de un horario semanal existente.                      | 2             |
| 48      | TS15          | Implementar endpoint para eliminar un horario semanal (`DELETE /weeklyschedules/{id}`)                 | Como developer,<br>quiero exponer un endpoint para eliminar un horario semanal,<br>para que los usuarios puedan eliminar un horario semanal del sistema.                                       | 2             |
| 49      | TS16          | Implementar endpoint para consultar un horario semanal por nombre (`GET /weeklyschedules/name/{name}`) | Como developer,<br>quiero exponer un endpoint para consultar un horario semanal por su nombre,<br>para que los usuarios puedan obtener los detalles del horario específico mediante el nombre. | 3             |


Para llevar un correcto orden del Product Backlog, se utilizó la herramienta de Pivotal Tracker.
...
Revolucionar la gestión administrativa de las academias educativas en el Perú, ofreciendo una plataforma que optimice procesos clave de matrícula, asistencia, asignación de horarios, control de finanzas y pagos.
...
**Demy** es una plataforma web que automatiza la gestión diaria de academias educativas. Permite controlar matrículas, horarios, asistencia, pagos y finanzas desde una interfaz accesible y fácil de usar. Está pensada para ser adoptada por usuarios con poca experiencia digital y reemplaza herramientas fragmentadas como hojas de cálculo o registros físicos.
...
**Mi organización: Bandeja de entrada (Administrador):**
Pantalla que muestra la bandeja de notificaciones 

![Wireframe-20](assets/images/wireframes-appweb/mobile/bandeja-notificaciones.png)

**Mi organización: Alumnos(Administrador):**
Pantalla que muestra un error al registrar un alumno

![Wireframe-21](assets/images/wireframes-appweb/mobile/error-datos-alumno.png)

**Mi organización: Alumnos(Administrador):**
Pantalla que muestra el error señalado en el campo de datos del alumno 

![Wireframe-22](assets/images/wireframes-appweb/mobile/error-señalado-alumno.png)

**Mi organización: Matrícula(Administrador):**
Pantalla que muestra un error al registrar una matrícula

![Wireframe-23](assets/images/wireframes-appweb/mobile/error-datos-matrícula.png)

**Mi organización: Matrícula(Administrador):*
Pantalla que muestra el error señalado en el campo de datos de la matrícula
...
![imagesFlowDiagrams](./assets/images/Muck_ups/Movil_Web_Browser/ADMIN/9Notificaciones/mobil-bandeja-notis.png)

**Panel de control - Alumnos**
En la siguiente imagen se muestra una ventana de error al registrar un alumno

![imagesFlowDiagrams](/assets/images/Muck_ups/Movil_Web_Browser/ADMIN/4Alumnos/mobile-error-alumno.png)

**Panel de control - Alumnos**
En la siguiente imagen se señala el error en un campo de dato del alumno

![imagesFlowDiagrams](/assets/images/Muck_ups/Movil_Web_Browser/ADMIN/4Alumnos/mobile-error-señalado-alumnos.png)

**Panel de control - Matrícula**
En la siguiente imagen se muestra una ventana de error al registrar una matrícula
...
| upc-pre-202501-1asi0730-4364-smartedu/demy-landing-page | testimonials  | 71ac258bb28a0aa96c0456c702d2ffa6b2aaeb51 | feat: add testimonial section to landing page                                          | —           | 21/04/2025   |
...
A continuación, se presenta una captura de pantalla de la herramienta de control que usamos, que fue Trello:
![Captura de Trello Sprint 2 Apps Web](./assets/screenshots/trello-sprint2-appweb.png)

Link del Trello: https://trello.com/invite/b/6819755e077e95c6b3682a8b/ATTIea86605d185797427dccb42b00317046C9E12A91/sprint-2-apps-web
