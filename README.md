...
| US01            | Iniciar sesión como usuario autenticado    | Como miembro del sistema Demy, quiero iniciar sesión con mis credenciales, para acceder a las funcionalidades permitidas por mi rol.               | **Scenario: Inicio de sesión exitoso**<br>Given un usuario con credenciales válidas<br>When intenta iniciar sesión<br>Then el sistema le permite el acceso a la plataforma según su rol asignado<br><br>**Scenario: Inicio de sesión con credenciales inválidas**<br>Given un usuario con credenciales incorrectas<br>When intenta iniciar sesión<br>Then se le informa que las credenciales son inválidas y no se permite el acceso                                                                                                                                                                                                                                                                                                                                                                                                                                     | EP01                      |
| US02            | Cerrar sesión de forma segura              | Como usuario autenticado, quiero cerrar sesión de forma segura, para evitar el uso indebido de mi cuenta.                                          | **Scenario: Cierre de sesión voluntario**<br>Given un usuario autenticado<br>When decide cerrar sesión<br>Then el sistema finaliza su sesión y revoca el acceso a funcionalidades protegidas<br><br>**Scenario: Cierre de sesión por inactividad**<br>Given un usuario inactivo por un periodo prolongado<br>When se cumple el tiempo límite<br>Then el sistema cierra la sesión automáticamente por seguridad                                                                                                                                                                                                                                                                                                                                                                                                                                                           | EP01                      |
| US03            | Acceder con permisos según el rol          | Como usuario del sistema, quiero que mis permisos de acceso estén definidos por mi rol, para interactuar únicamente con lo que me corresponde.     | **Scenario: Usuario con rol administrador**<br>Given un usuario autenticado con rol de administrador<br>When accede al sistema<br>Then puede acceder a funcionalidades de gestión global como matrículas o pagos<br><br>**Scenario: Usuario con rol docente**<br>Given un usuario autenticado con rol de docente<br>When accede al sistema<br>Then puede gestionar asistencia y horarios asignados                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | EP01                      |
| US04            | Recuperar acceso mediante correo           | Como usuario que ha perdido el acceso, quiero recuperar mi contraseña mediante correo electrónico, para restablecer mi cuenta de forma segura.     | **Scenario: Solicitud de recuperación exitosa**<br>Given un usuario registrado que olvidó su contraseña<br>When solicita la recuperación e ingresa su correo asociado<br>Then el sistema le envía un enlace temporal para crear una nueva contraseña<br><br>**Scenario: Solicitud con correo no registrado**<br>Given un usuario que ingresa un correo no asociado<br>When solicita recuperación<br>Then se le informa que no existe una cuenta vinculada a ese correo                                                                                                                                                                                                                                                                                                                                                                                                   | EP01                      |
| US05            | Registrarse como usuario en la plataforma  | Como usuario interesado en la plataforma, quiero registrarme creando una cuenta, para acceder a las funcionalidades de la plataforma según mi rol. | **Scenario 1: Registro exitoso como usuario administrativo**<br>Given un visitante ingresa al formulario de registro<br>When elige la opción de registrarse como administrativo<br> And proporciona su información de contacto, nombre de la academia y correo<br>Then el sistema crea una cuenta administrativa<br><br>**Scenario 2: Registro exitoso como docente**<br>Given un visitante ingresa al formulario de registro<br>When elige la opción de registrarse como docente<br>And proporciona su información de contacto, nombre de la academia y correo<br>Then el sistema crea una cuenta con el rol de docente<br><br>**Scenario 3: Registro con datos incompletos**<br>Given un visitante que omite datos obligatorios (nombre, correo, etc.)<br>When intenta registrarse<br>Then el sistema muestra los campos faltantes y solicita completar la información | EP01                      |
| US06            |                                            |                                                                                                                                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |                           |
| US07            |                                            |                                                                                                                                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |                           |
| US08            |                                            |                                                                                                                                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |                           |
| US09            |                                            |                                                                                                                                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |                           |
...
| 34      | TS01          | Implementar endpoint para registrar nueva matrícula (`POST /enrollments`)      | **Scenario 1:** Registro exitoso<br>Given que el usuario es un administrador autenticado,<br>When envía una solicitud POST con datos válidos de matrícula (estudiante, curso, periodo),<br>Then la matrícula debe guardarse correctamente y responder con status 201 Created.<br><br>**Scenario 2:** Datos incompletos<br>Given que falta algún dato obligatorio,<br>When se intenta registrar la matrícula,<br>Then se debe responder con status 400 Bad Request y un mensaje de error descriptivo.<br><br>**Scenario 3:** Matrícula duplicada<br>Given que el estudiante ya está matriculado en ese curso/periodo,<br>When se intenta registrar una matrícula duplicada,<br>Then se debe responder con status 409 Conflict.                                                  | 3            |
| 35      | TS02          | Implementar endpoint para consultar matrícula por ID (`GET /enrollments/{id}`) | **Scenario 1:** Matrícula encontrada<br>Given que el ID de matrícula existe,<br>When se hace una solicitud GET al endpoint con ese ID,<br>Then debe devolverse la información completa de la matrícula con status 200 OK.<br><br>**Scenario 2:** Matrícula no encontrada<br>Given que el ID de matrícula no existe,<br>When se hace la solicitud GET,<br>Then debe devolverse status 404 Not Found con un mensaje de error.                                                                                                                                                                                                                                                                                                                                                    | 2            |
| 36      | TS03          | Implementar endpoint para listar matrículas filtradas (`GET /enrollments`)     | **Scenario 1:** Listado completo<br>Given que el usuario está autenticado,<br>When realiza una solicitud GET sin filtros,<br>Then se debe devolver la lista completa de matrículas activas con status 200 OK.<br><br>**Scenario 2:** Filtros aplicados<br>Given que el usuario incluye filtros como `studentId`, `period`, `course`,<br>When realiza la solicitud,<br>Then se debe devolver solo las matrículas que coincidan con esos filtros.<br><br>**Scenario 3:** Paginación<br>Given que el sistema tiene muchas matrículas,<br>When se incluyen parámetros de paginación (`page`, `limit`),<br>Then se debe devolver solo el subset correspondiente y metadatos de la paginación.                                                                                       | 2            |
| 37      | TS04          | Implementar endpoint para registrar asistencia (`POST /attendances`)           | **Scenario 1:** Registro exitoso<br>Given que el docente está autenticado,<br>When envía una solicitud POST con lista de asistencias válidas (fecha, curso, estudiantes),<br>Then se deben registrar todas las asistencias con status 201 Created.<br><br>**Scenario 2:** Datos inválidos<br>Given que falta algún dato requerido,<br>When se realiza la solicitud,<br>Then debe devolverse status 400 Bad Request con el campo inválido resaltado.<br><br>**Scenario 3:** Registro duplicado<br>Given que ya existe un registro de asistencia para ese estudiante, curso y fecha,<br>When se intenta duplicar el registro,<br>Then debe devolverse status 409 Conflict.                                                                                                       | 3            |
| 38      | TS05          | Generar y enviar alertas automáticas de morosidad (`POST /payment-alerts`)     | **Scenario 1:** Morosidad detectada<br>Given que existen estudiantes con pagos vencidos,<br>When se ejecuta el endpoint POST manualmente o por tarea automática,<br>Then se deben enviar las notificaciones correspondientes y devolver status 200 OK.<br><br>**Scenario 2:** Sin morosidad<br>Given que no hay morosidad,<br>When se ejecuta el endpoint,<br>Then debe devolverse status 204 No Content.<br><br>**Scenario 3:** Error parcial<br>Given que ocurre un error al enviar una notificación,<br>When se procesa la alerta,<br>Then se debe registrar el error y devolver status 207 Multi-Status con detalle parcial.                                                                                                                                               | 3            |
| 39      | TS06          | Exponer endpoint para consultar horarios por docente (`GET /schedules`)        | **Scenario 1:** Consulta propia<br>Given que el docente está autenticado,<br>When hace una solicitud GET a `/schedules`,<br>Then debe obtener su horario completo de clases con status 200 OK.<br><br>**Scenario 2:** Consulta por administrador<br>Given que el usuario es administrador y envía un parámetro `teacherId`,<br>When hace la solicitud,<br>Then debe obtener los horarios asignados a ese docente.<br><br>**Scenario 3:** Sin horarios<br>Given que no hay horarios asignados,<br>When se hace la solicitud,<br>Then debe devolverse una lista vacía y status 200 OK.                                                                                                                                                                                           | 1            |
| 40      | TS07          | Documentar todos los endpoints usando Swagger y OpenAPI                        | **Scenario 1:** Documentación disponible<br>Given que los endpoints han sido desarrollados,<br>When se accede a `/swagger-ui.html` o similar,<br>Then debe mostrarse una documentación clara, completa y navegable de todos los endpoints disponibles.<br><br>**Scenario 2:** Especificaciones correctas<br>Given que la documentación está generada,<br>When se revisan los métodos, parámetros, cuerpos y respuestas,<br>Then todos deben coincidir con el comportamiento real del sistema.<br><br>**Scenario 3:** Accesible solo para roles autorizados (opcional)<br>Given que el proyecto requiere restringir la documentación,<br>When un usuario sin privilegios accede a la ruta de Swagger,<br>Then debe ser redirigido o recibir un mensaje de acceso no autorizado. | 1            |
| 41      | TS08          | Configurar autenticación y autorización basado en roles (admin/docente)        | **Scenario 1:** Acceso autorizado<br>Given que un usuario autenticado tiene el rol adecuado,<br>When accede a un endpoint protegido,<br>Then la solicitud debe completarse correctamente con status 200 OK.<br><br>**Scenario 2:** Acceso denegado<br>Given que un usuario autenticado no tiene el rol adecuado,<br>When accede a un recurso restringido,<br>Then debe recibir status 403 Forbidden.<br><br>**Scenario 3:** Usuario no autenticado<br>Given que el usuario no está autenticado,<br>When intenta acceder a un endpoint protegido,<br>Then debe recibir status 401 Unauthorized.                                                                                                                                                                                 | 2            |
| 42      | TS09          | Exponer endpoint para consultar dashboard financiero (`GET /finance/summary`)  | **Scenario 1:** Acceso autorizado<br>Given que el usuario autenticado es administrador,<br>When accede a `/finance/summary`,<br>Then debe recibir el resumen financiero actualizado (ingresos, egresos, balances) con status 200 OK.<br><br>**Scenario 2:** Acceso no autorizado<br>Given que el usuario no tiene permisos,<br>When hace la solicitud,<br>Then debe recibir status 403 Forbidden.<br><br>**Scenario 3:** Sin datos<br>Given que no hay información financiera registrada,<br>When se accede al endpoint,<br>Then debe devolverse status 200 OK con valores en cero o estructura vacía.                                                                                                                                                                         | 3            |
| 43      | TS10          | Implementar lógica de búsqueda y paginación por nombre o código                | **Scenario 1:** Búsqueda exitosa<br>Given que el usuario está autenticado,<br>When envía una búsqueda con parámetros válidos (`?query=juan`),<br>Then debe recibir una lista filtrada correctamente con status 200 OK.<br><br>**Scenario 2:** Sin coincidencias<br>Given que la búsqueda no arroja resultados,<br>When se realiza la solicitud,<br>Then debe devolverse una lista vacía y status 200 OK.<br><br>**Scenario 3:** Paginación<br>Given que se envían parámetros `page` y `limit`,<br>When se hace la solicitud,<br>Then la respuesta debe incluir solo los elementos correspondientes junto con metadatos (`total`, `pages`, `currentPage`).                                                                                                                      | 2            |
| 44      | TS11          | Aplicar control de errores estandarizado y manejo global de excepciones        | **Scenario 1:** Validaciones<br>Given que una solicitud contiene datos inválidos,<br>When se detecta un error de validación,<br>Then se debe responder con status 400 Bad Request y una estructura clara de errores (`field`, `message`).<br><br>**Scenario 2:** Recurso no encontrado<br>Given que se busca un recurso inexistente,<br>When ocurre la excepción,<br>Then se debe responder con status 404 Not Found.<br><br>**Scenario 3:** Errores internos<br>Given que ocurre una excepción inesperada,<br>When se ejecuta una operación fallida,<br>Then se debe devolver status 500 Internal Server Error y loguear el detalle para debugging.                                                                                                                           | 2            |
| 45      | TS12          | Implementar estrategia de versionamiento de la API (ej. `api/v1/`)             | **Scenario 1:** Endpoints versionados<br>Given que los endpoints están implementados,<br>When se accede vía `/api/v1/...`,<br>Then deben funcionar correctamente sin afectar versiones futuras o anteriores.<br><br>**Scenario 2:** Versiones adicionales<br>Given que se desea evolucionar la API,<br>When se agrega una nueva versión (ej. `v2`),<br>Then la anterior (`v1`) debe mantenerse operativa hasta ser oficialmente deprecada.<br><br>**Scenario 3:** Estructura consistente<br>Given que se utiliza versionamiento,<br>When se definen nuevas rutas,<br>Then todas deben seguir el patrón `/api/v{n}/recurso` para mantener consistencia.                                                                                                                         | 1            |
| 46      | TS13          | --                                                                             | -                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | -            |
| 47      | TS14          | --                                                                             | -                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | -            |
