...
| US16            |                                          |                                                                                                                                        |                                                                                                                                                                                                                                                                                                                                                                                                      |                           |
| US17            |                                          |                                                                                                                                        |                                                                                                                                                                                                                                                                                                                                                                                                      |                           |
| US18            | Crear materias por periodo de estudio    | Como administrativo quiero crear materias por periodo de estudio  para mantener un control claro del contenido académico en cada ciclo | Given que el usuario tiene rol administrativo <br> When ingresa a su organización <br> And presiona el botón " Periodos" <br> And presiona el botón Gestión de materias <br/> And registra los datos de su nueva materia <br/>Then el sistema muestra un mensaje de confirmación                                                                                                                     | EP05                      |
| US19            | Asignar horarios a los docentes y cursos | Como administrativo quiero asignar horarios a los docentes y cursos para evitar conflictos de disponibilidad                           | Given que el usuario tiene rol administrativo <br/> And existe una materia registrada en el periodo <br/> When el usuario asigna el horario al curso <br/> And selecciona el docente <br/> Then el sistema guarda el registro exitosamente<br/>And muestra un mensaje de confirmación                                                                                                                | EP05                      |
| US20            | Consultar disponibilidad de salones      | Como administrativo quiero consultar la disponibilidad de salones para asignar clases de manera eficiente                              | Given que el usuario tiene rol administrativo <br/>  And accede a la gestión de salones <br/> When seleccione el rango de hora que desea disponible <br/> Then el sistema muestra una lista de salones en el horario disponible                                                                                                                                                                      | EP05                      |
| US21            | Reprogramar clase por cambio de horario  | Como docente quiero reprogramar la clase por cambio de horario para garantizar el aprendizaje de mis alumnos sin retrasos              | Given que el usuario tiene rol docente <br/> And accede a la gestión de clases <br/> And selecciona reprogramación de clases <br/> And selecciona la hora en la que desea recuperar <br/> And el sistema le muestra los salones disponibles a la hora que desea recuperar <br/> When el docente selecciona el salón disponible <br/> Then el sistema le muestra un mensaje de reprogramación exitosa | EP05                      |
| US22            | Actualizar calendario del docente        | Como docente quiero visualizar automáticamente la reprogramación  de la clase en mi horario para estar siempre al tanto de ello        | Given que el usuario tiene rol docente <br/> And tiene una clase reprogramada<br/>  When acceda a su visualización de horario <br/> Then el sistema le muestra su horario actualizado con la clase reprogramada                                                                                                                                                                                      | EP05                      |
| LPS01           |                                          |                                                                                                                                        |                                                                                                                                                                                                                                                                                                                                                                                                      |                           |
| LPS02           |                                          |                                                                                                                                        |                                                                                                                                                                                                                                                                                                                                                                                                      |                           |
| LPS03           |                                          |                                                                                                                                        |                                                                                                                                                                                                                                                                                                                                                                                                      |                           |
| LPS04           |                                          |                                                                                                                                        |                                                                                                                                                                                                                                                                                                                                                                                                      |                           |
